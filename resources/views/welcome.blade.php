...
<div class="banner_section full_screen staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade carousel_style1 light_arrow" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active background_bg overlay_bg_60" data-img-src="{{ asset('assets/images/course_img6.jpg')}}">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                    <div class="row justify-content-center">
                        <div class="col-lg-7 col-md-12 col-sm-12 text-center">
                            <div class="banner_content text_white">
                                <h2 class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.2s">Kurslar</h2>
                                ...
                                <a class="btn btn-default btn-radius staggered-animation" href="{{route('courseus.index')}}" data-animation="fadeInUp" data-animation-delay="0.6s">Boshlash</a>
                                <a class="btn btn-white btn-radius staggered-animation" href="#post" data-animation="fadeInUp" data-animation-delay="0.6s">Ko'proq</a>
                            </div>
                        </div>
                    </div>
                </div><!-- END CONTAINER-->
            ...
            <div class="carousel-item background_bg overlay_bg_60" data-img-src="{{ asset('assets/images/course_img5.jpg')}}">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-12 col-sm-12 text-center">
                                <div class="banner_content text_white">
                                    <h2 class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.2s">Hoziroq boshlang Porloq Kelajak Uchun</h2>
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                                    <a class="btn btn-default btn-radius staggered-animation" href="{{route('courseus.index')}}" data-animation="fadeInUp" data-animation-delay="0.6s">Boshlash</a>
                                	<a class="btn btn-white btn-radius staggered-animation" href="#post" data-animation="fadeInUp" data-animation-delay="0.6s">Ko'proq</a>
                                </div>
            ...
            <div class="carousel-item background_bg overlay_bg_60" data-img-src="{{ asset('assets/images/course_img4.jpg')}}">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-12 col-sm-12 text-center">
                                <div class="banner_content text_white">
                                    <h2 class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.2s">Online Kurslar</h2>
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                                    <a class="btn btn-default btn-radius staggered-animation" href="{{route('courseus.index')}}" data-animation="fadeInUp" data-animation-delay="0.6s">Boshlash</a>
                                	<a class="btn btn-white btn-radius staggered-animation" href="#post" data-animation="fadeInUp" data-animation-delay="0.6s">Ko'proq</a>
                                </div>
        ...
        <div class="row justify-content-center">
        	<div class="col-lg-4 col-md-6 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
            	<div class="icon_box icon_box_style1 box_shadow1 text-center">
                    ...
                    <div class="icon_box_content">
                    	<a href="https://t.me/onatilivaadabiyoti_nazoratishi"><h5>Administrator</h5></a>
                        <a href="https://t.me/onatilivaadabiyoti_nazoratishi"><p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 animation" data-animation="fadeInUp" data-animation-delay="0.3s">
            	<div class="icon_box icon_box_style1 box_shadow1 text-center">
                    ...
                    <div class="icon_box_content">
                    	<a href="{{route('courseus.index')}}" ><h5>Online Kurslar</h5></a>
                        <a href="{{route('courseus.index')}}" ><p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 animation" data-animation="fadeInUp" data-animation-delay="0.4s">
            	<div class="icon_box icon_box_style1 box_shadow1 text-center">
                    ...
                    <div class="icon_box_content">
                    	<a href="https://t.me/onatilivaadabiyoti_nazoratishi"><h5>Kurslar</h5></a>
                            <a href="https://t.me/onatilivaadabiyoti_nazoratishi"><p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p></a>
                    </div>
                </div>
            </div>
                ...
                <div class="courses_box radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                    <div class="courses_img"> 
                  	...
                  	<div class="courses_info">
                    	...
                    	<h5 class="courses_title"><a href="{{ route('postus.show', $post->id) }}"> {{$post->name}}</a></h5>
                        <div class="courses_teacher"> 
                            <a href="{{ route('postus.show', $post->id) }}"><img src="{{asset('assets/images/user.png')}}" alt="user1"><span>{{$post->author}}</span></a> 
                        </div>
                        <div class="courses_footer">
                            <ul class="courses_meta">
                                <li><a href="{{ route('postus.show', $post->id) }}" ><i class="ti-comments"></i><span>{{count($post->comment)}}</span></a></li>
                                <li><a href="{{ route('postus.show', $post->id) }}"><i class="ti-time"></i>{{ Carbon\Carbon::parse($post->created_at)->format('M d ') }}</span>{{ Carbon\Carbon::parse($post->created_at)->format('- Y') }}</a></li>
                            </ul>
                        </div>
                  	</div>
                </div>
