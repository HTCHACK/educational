                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <form method="POST" action="{{ route('banners.update',$banner->id) }}" class="form-group"
                                        enctype="multipart/form-data">

                                        @csrf
                                        @method('put')
                                        <div class="form-group">{{ $banner->title }}
                                            <input type="text" class="form-control"  placeholder="Enter file Name"
                                                name="title">
                                        </div>
                                        <div class="form-group">{{ $banner->subtitile }}
                                            <input type="text" class="form-control"  placeholder="Enter file Name"
                                                name="subtitile">
                                        </div>
                                        <img src="{{ asset('storage/' . $banner->image) }}" width="100px" height="70px">
