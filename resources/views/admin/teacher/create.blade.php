                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <form method="POST" action="{{ route('teachers.store') }}" class="form-group"
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control"  placeholder="O'qituvchi Mutaxassisligi" 
                                                name="profession">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control"  placeholder="https://www.facebook.com/alisher.halimjonov.1 shunga oxshash" 
                                                name="facebook">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control"  placeholder="https://www.facebook.com/alisher.halimjonov.1 shunga oxshash" 
