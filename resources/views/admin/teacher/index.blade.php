                                        ...
                                        <tbody>
                                            @foreach ($teachers as $key => $teacher)
                                                <tr>
                                                    ...
                                                    <td class="text-primary">{{ $teacher->fullname }}</td>
                                                    <td class="text-primary"><img
                                                            src="{{ asset('storage/' . $teacher->image) }}" width="100px"
                                                            height="70px"></td>
                                                    ...
                                                    <td class="text-primary">
                                                        ...
                                                        <form id="logout-form" action="{{ route('teachers.destroy',[$teacher->id]) }}" method="post" style="display:none;background-color:#007bff;">
