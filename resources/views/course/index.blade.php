...
@section('title')
    ...
    <meta property="og:image" content="{{ asset('assets/images/course.jpg') }}" />
@endsection
...
@section('content')
    ...
    <div class="breadcrumb_section background_bg overlay_bg_50 page_title_light"
        data-img-src="{{ asset('assets/images/course.jpg') }}">
        <div class="container">
            <!-- STRART CONTAINER -->
            <div class="row">
                <div class="col-sm-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="carousel_slider owl-carousel owl-theme" data-dots="false" data-margin="20" data-loop="true"
                        data-autoplay="true"
                        data-responsive='{"0":{"items": "1"}, "767":{"items": "2"}, "1199":{"items": "3"}}'>
                        @foreach ($courses as $key => $course)
                            <div class="item">
                                <div class="courses_box radius_all_10 box_shadow1">
                                    <div class="courses_img">
                                        <a href="{{ route('courseus.show', $course->id) }}"><img
                                                src="{{ asset('storage/' . $course->image) }}" alt="course_img1"></a>
                                    </div>
                                    <div class="courses_info">
                                        ...
                                        <h5 class="courses_title"><a
                                                href="{{ route('courseus.show', $course->id) }}">{{ $course->name }}</a>
                                        </h5>
                                        <div class="courses_teacher">
                                            <a href="{{ route('courseus.show', $course->id) }}"><img
                                                    src="{{ asset('assets/images/user.png') }}"
                                                    alt="user1"><span>{{ $course->author }}</span></a>
                                        </div>
                                        <div class="courses_footer">
                                            <ul class="courses_meta">
                                                <li><a href="{{ route('courseus.show', $course->id) }}"><i
                                                            class="ti-time"></i><span>{{ Carbon\Carbon::parse($course->created_at)->format('M d Y') }}</span></a>
                                                </li>
                                            </ul>
